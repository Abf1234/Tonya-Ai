...
export default function LearnPage() {
  return (
    <FeaturePage
      ...
      description="Guidance covers impersonation, phishing, fake recruitment, scholarships, mobile-money fraud, investment schemes, misinformation and safer evidence handling. The platform remains educational and non-partisan."
    ...
    >
      <div className="grid gap-5 md:grid-cols-2">
        {[
          ...
          <Card key={title} className="flex gap-4 p-6" interactive>
